...
#  4) 논리형(boolean): True, False  대문자로 쓰래요 앞글자 알았죠?
...
# 문자열 정수형("3") -> 정수형(3)
# 문자열 정수형("3") -> 실수형(3.0)
# 문자열 실수형("3.14") -> 정수형(Error)  이것만 안된다네요. 알았죠???
# print(int(str_float_d = "9.2"))
...
# "Null Pointer Exception" 종료된다 알긌느냐ㅑㅑㅑㅑㅑㅑ 위에꺼 쓰면은 아래꺼 쓰거라 none쓰지마라 이이잉
...
#  * Python: 객체만 사용
# 기억에 남는거 널이 아니야 널이 뭐야 나중에 알게된다는데 언제일까용~?
...
#   문법: num = 5
#   * num: "num" 변수 생성
#   * 대입연산자(=): 우측의 값을 좌측에 저장    내 마음속에 저장 찰칵ㄱ 는 아니다 저장이다 저장
#   * 동등연산자(==): Equal 요것이 같다
...
# 9.동적 출력
print("="*200)
student_num = 20233068
student_name = "Jina"
# 출력 예: "조선대학교 20233068, jina 입니다."
print("조선대학교 20233068, jina 입니다.") # 하드 코딩 지양
# 1. format() - Old
